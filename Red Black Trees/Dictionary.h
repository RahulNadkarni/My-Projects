...
private:
    ...
    struct Node{
     ...
     Node* preOrder(Node* R, Node* N);

     void LeftRotate(Node* R, Node* x); 
     void RightRotate(Node* R, Node* x); 
     void RB_InsertFixUp(Node* R, Node* z); 
     void RB_Transplant(Node* R, Node* u, Node* v); 
     void RB_DeleteFixUp(Node* R, Node* x); 
     void RB_Delete(Node* R, Node* z);   
public:
   ...
   // are separated by the sequency space-colon-space " : ". The pairs are arranged 
